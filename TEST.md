...
<!--
+ Not executing the REFMOD module:
```
nextflow \
    -log "/tmp/nextflow/log/nf-searchengine.log" \
    run main.nf   \
...
nextflow \
    ...
    run main.nf   \
        ...
        --msf_params_file "/mnt/tierra/U_Proteomica/UNIDAD/Softwares/jmrodriguezc/nf-SearchEngine/samples/heteroplasmic_heart/inputs/msf_params_file.params" \
        --reporter_ion_isotopic "/mnt/tierra/U_Proteomica/UNIDAD/Softwares/jmrodriguezc/nf-SearchEngine/samples/heteroplasmic_heart/inputs/reporter_ion_isotopic.tsv" \
        --dm_file "/mnt/tierra/U_Proteomica/UNIDAD/Softwares/jmrodriguezc/nf-SearchEngine/samples/heteroplasmic_heart/inputs/dm_list.tsv" \
        --refmod_params_file "/mnt/tierra/U_Proteomica/UNIDAD/Softwares/jmrodriguezc/nf-SearchEngine/samples/heteroplasmic_heart/inputs/refmod_params_file.ini" \
        --outdir  "/mnt/tierra/U_Proteomica/UNIDAD/Softwares/jmrodriguezc/nf-SearchEngine/samples/heteroplasmic_heart/results" \
        -resume
```
...
nextflow \
    ...
    run main.nf   \
        ...
        --create_mzml false \
        --add_decoys true \
        --raw_files "samples/heteroplasmic_liver/inputs/mzMLs/*.mzML" \
        --database "samples/heteroplasmic_liver/inputs/database.fasta" \
        --decoy_prefix "DECOY_"\
        --msf_params_file "samples/heteroplasmic_liver/inputs/msf_params_file.params" \
        --reporter_ion_isotopic "samples/heteroplasmic_liver/inputs/reporter_ion_isotopic.tsv" \
        --dm_file "samples/heteroplasmic_liver/inputs/dm_list.tsv" \
        --refmod_params_file "samples/heteroplasmic_liver/inputs/refmod_params_file.ini" \
...
nextflow \
    ...
    run main.nf   \
        ...
        --dm_file "/mnt/tierra/U_Proteomica/UNIDAD/Softwares/jmrodriguezc/nf-SearchEngine/samples/heteroplasmic_liver/inputs/dm_list.tsv" \
        --refmod_params_file "/mnt/tierra/U_Proteomica/UNIDAD/Softwares/jmrodriguezc/nf-SearchEngine/samples/heteroplasmic_liver/inputs/refmod_params_file.ini" \
...
nextflow \
    ...
    run main.nf   \
        ...
        --dm_file "/mnt/tierra/U_Proteomica/UNIDAD/Softwares/jmrodriguezc/nf-SearchEngine/samples/heteroplasmic_muscle/inputs/dm_list.tsv" \
        --refmod_params_file "/mnt/tierra/U_Proteomica/UNIDAD/Softwares/jmrodriguezc/nf-SearchEngine/samples/heteroplasmic_muscle/inputs/refmod_params_file.ini" \
